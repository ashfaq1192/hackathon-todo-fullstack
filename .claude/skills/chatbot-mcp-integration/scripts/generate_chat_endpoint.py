...
def generate_chat_endpoint_script(output_dir: str):
    chat_endpoint_filename = "chat.py"
    chat_endpoint_file_path = os.path.join(output_dir, chat_endpoint_filename)

    chat_endpoint_content = f"""
